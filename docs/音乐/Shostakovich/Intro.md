...
<small>这篇文章中的作品解读和版本推荐都是个人向的。文章中的小标题标注了作品的英文全名，可以以此搜索，嵌入的播放器是 Apple Music 的，对于其它平台也可以起到一个认封面的作用。如果没有“版本推荐”栏目的话，说明我没有特别对比过这首曲子的版本，只是放了我自己常听的……可以参考最上面的指挥推荐挑选一下。</small>
